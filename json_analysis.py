...
tick_step = 300
fig.update_xaxes(title='block number (0 is block-27307800)', row=1, col=1, tickvals=idx_list[::tick_step])
...
fig.update_xaxes(title_text="block number (0 is block-27307800)", row=2, col=1)
